      ...
      <div className="flex gap-8">
        ...
        <div className="flex-1 bg-white shadow-md rounded-lg p-6">
          ...
          <div className="flex flex-col space-y-4">
            <div className="flex items-center justify-between border-b border-gray-200 pb-4">
              ...
              <div className="flex-1 ml-4">
                ...
                <p className="text-gray-600 mb-2 ">
                  What's Good Mekis Sweet Almond Oil With Grape seed combo for
                  your skin and Hair? Sweet almond
                </p>
            ...
            <button className="bg-red-400 w-[200px] text-white p-3 mt-3 rounded-md font-semibold">
              Clear Cart
            </button>
          </div>
        </div>
        ...
        <div className="w-80 bg-white shadow-md rounded-lg p-6">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex justify-between">
              <span className="text-lg font-medium">Shopping</span>
