...
import React, { useState } from "react"; //( i added chatGPT's)
import Rating from "@mui/material/Rating"; //( i added chatGPT's)

const Order = () => {
  const [value, setValue] = useState(2.403); // (i added chatGPT's)
                ...
                <div className="mb-4 ">
                  ...
                  <div className="flex flex-col">
                    ...
                    <Rating //( i added chatGPT's)
                      ...
                      sx={{
                        //( i added chatGPT's again)
                        "& .MuiRating-iconFilled": {
                          color: "gray", // رنگ خاکستری برای ستاره‌های پر شده
                        },
                        "& .MuiRating-iconHover": {
                          color: "darkgray", // رنگ خاکستری تیره هنگام hover
                        },
                      }} //( i added chatGPT's again)
                    />
                    <textarea
