        ...
        <div className="flex-1 bg-white p-5">
          <div className="flex flex-col">
            ...
            <div className="flex flex-col my-3">
              ...
              <input
                type="text"
                className="w-[250px] outline-none border-b-2 border-[#444] border-solid" onChange={(e) => setTitle(e.target.value)}
              />
            </div>
            ...
            <div className="flex flex-col my-3">
              ...
              <input
                type="text"
                className="w-[250px] outline-none border-b-2 border-[#444] border-solid" onChange={(e) => setSubtitle(e.target.value)}
              />
            </div>
