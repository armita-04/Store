      ...
      <div className="flex  flex-col md:flex-row gap-5">
        ...
        <div className="flex-1 bg-white p-5 shadow-lg rounded-lg">
          <div className="flex items-center mb-5">
            <img src="https://images.pexels.com/photos/8101532/pexels-photo-8101532.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" className="h-20 w-20 rounded-full mr-5" />
      ...
      <div className="mt-5 bg-white p-5 shadow-lg rounded-lg">
        <form action="" className="flex flex-col md:flex-row gap-4">
          ...
          <div className="flex-1 flex flex-col items-center space-y-5">
              ...
              <img src="https://images.pexels.com/photos/8101532/pexels-photo-8101532.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" className="h-40 w-40 rounded-full mr-5" />
